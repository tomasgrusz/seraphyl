import { OrbitControls, PerspectiveCamera, Sparkles, useGLTF, Float } from '@react-three/drei';
...
import { CylinderGeometry, Mesh, MeshBasicMaterial, SpotLight } from 'three';
